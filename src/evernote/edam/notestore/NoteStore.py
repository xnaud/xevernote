      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i199 in xrange(_size195):
            _elem200 = evernote.edam.type.ttypes.SharedNotebook()
            _elem200.read(iprot)
...
class expungeSharedNotebooks_args(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i206 in xrange(_size202):
            ...
            self.sharedNotebookIds.append(_elem207)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.sharedNotebookIds != None:
      ...
      for iter208 in self.sharedNotebookIds:
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i213 in xrange(_size209):
            _elem214 = evernote.edam.type.ttypes.LinkedNotebook()
            _elem214.read(iprot)
