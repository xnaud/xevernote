...
class NoteVersionId(object):
  ...
  thrift_spec = (
    ...
    (3, TType.I64, 'serviceUpdated', None, None, ), # 3
  )

  def __init__(self, updateSequenceNum=None, updated=None, serviceUpdated=None,):
  ...
  def write(self, oprot):
    ...
    if self.serviceUpdated != None:
      oprot.writeFieldBegin('serviceUpdated', TType.I64, 3)
